Public Class CashBack
    Public Shared cashBack As Decimal

    Private Sub CashBack_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'txbAmount.Focus() - set tabstop instead.
        If cashBack >= 0 Then
            txbAmount.Text = FormatCurrency(cashBack)
        End If
    End Sub
